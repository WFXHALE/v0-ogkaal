  ...
  return (
    ...
    >
      {avatarUrl ? (
        ...
        <span
          className="font-bold text-[#0B0E11] leading-none"
...
// ── Logged-out popup with inline sign-in / register form ─────────────────────
              ...
              <form onSubmit={handleRegister} className="space-y-2">
                ...
                <div className="flex items-center gap-2 px-3 py-2 rounded-xl border border-border bg-secondary/20 focus-within:border-primary transition-colors">
                  ...
                  <input
                    type="email"
                    value={regEmail}
                    onChange={(e) => setRE(e.target.value.trim().toLowerCase())}
                    placeholder="Email"
                    required
                    className="flex-1 bg-transparent text-xs text-foreground placeholder:text-muted-foreground focus:outline-none"
                  />
                ...
                <div className="flex items-center gap-2 px-3 py-2 rounded-xl border border-border bg-secondary/20 focus-within:border-primary transition-colors">
                  ...
                  <input
                    value={regId}
                    onChange={(e) =>
                      setRI(e.target.value.toLowerCase().replace(/[^a-z0-9_]/g, ""))
                    }
