...
import { Send, MessageCircle, Phone, Mail, CheckCircle, Loader2, ArrowLeft } from "lucide-react"
...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Store the submission in localStorage for admin dashboard
      if (data.submission) {
  ...
  const socialLinks = [
    {
      ...
      color: "bg-[#0088cc]/10 hover:bg-[#0088cc]/20 text-[#0088cc] border-[#0088cc]/30",
    ...
    },
    {
      ...
      color: "bg-[#25D366]/10 hover:bg-[#25D366]/20 text-[#25D366] border-[#25D366]/30",
      description: "Chat with us directly on WhatsApp",
    },
    {
      name: "Instagram",
      icon: InstagramIcon,
      href: "https://instagram.com/ogkaaltrader",
      color: "bg-[#E4405F]/10 hover:bg-[#E4405F]/20 text-[#E4405F] border-[#E4405F]/30",
      description: "Follow us for daily trading insights",
    },
  ]
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Have questions about our trading services? Reach out to us through any of
              ...
              <div className="mt-8 p-6 rounded-xl bg-card border border-border">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3 text-muted-foreground">
                    ...
                    <span>contact@ogkaaltrader.com</span>
                  </div>
                </div>
              </div>
            </div>
