            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-border bg-secondary/50">
                  <th className="text-left py-4 px-4 text-xs font-semibold text-muted-foreground uppercase">
                    Name
                  </th>
                  <th className="text-left py-4 px-4 text-xs font-semibold text-muted-foreground uppercase">
                    Contact
                ...
                {filteredSubmissions.length === 0 ? (
                  ...
                  filteredSubmissions.map((submission) => (
                    ...
                    >
                      ...
                      <td className="py-4 px-4">
                        <span
                          className={`inline-flex px-2 py-1 rounded-md text-xs font-medium border ${getTypeColor(submission.type)}`}
                        >
                      ...
                      <td className="py-4 px-4">
                        <div className="text-sm text-muted-foreground max-w-[200px]">
                          {Object.entries(submission.details).map(
                            ([key, value]) => (
                        ...
                        <div className="flex items-center gap-2">
                          {submission.status === "pending" ? (
                            ...
                            <Button
                              ...
                              size="sm"
                              onClick={() =>
                                updateStatus(submission.id, "pending")
                              }
