  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 px-4 py-10 max-w-5xl mx-auto w-full space-y-6">
        ...
        {/* Funded Account Progress — only shown if override data exists for this user */}
        {override && (
          <Section title="Funded Account Progress" icon={DollarSign}>
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 mt-2">
              <div className="rounded-xl border border-border bg-secondary/30 p-4 flex items-center gap-4">
                ...
                <div>
                  <p className="text-xs text-muted-foreground">Funded Accounts Passed</p>
                  <p className="text-2xl font-bold text-green-400">{override.fundedAccountsPassed}</p>
                </div>
              </div>
              <div className="rounded-xl border border-border bg-secondary/30 p-4 flex items-center gap-4">
                ...
                <div>
                  <p className="text-xs text-muted-foreground">Accounts Breached</p>
                  <p className="text-2xl font-bold text-red-400">{override.fundedAccountsBreached}</p>
                </div>
              </div>
              <div className="rounded-xl border border-border bg-secondary/30 p-4 flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-foreground">${override.totalPayouts.toLocaleString()}</p>
                </div>
              </div>
              <div className="rounded-xl border border-border bg-secondary/30 p-4 flex items-center gap-4">
                <div className="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  ...
                  <p className={`text-2xl font-bold ${override.totalReturn >= 0 ? "text-green-400" : "text-red-400"}`}>
                    {override.totalReturn >= 0 ? "+" : ""}{override.totalReturn}%
                  </p>
                </div>
              </div>
              <div className="rounded-xl border border-border bg-secondary/30 p-4 flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-foreground">{override.winRate}%</p>
                </div>
              </div>
              <div className="rounded-xl border border-border bg-secondary/30 p-4 flex items-center gap-4">
                <div className="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-foreground">{override.totalTrades}</p>
                </div>
              </div>
            </div>
          </Section>
        ...
        {/* Empty state for personal sections */}
        {!userId && (
